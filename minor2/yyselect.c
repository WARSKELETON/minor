/*
generated at Sat May  9 18:49:44 2020
...
static void yylabel(NODEPTR_TYPE a, NODEPTR_TYPE u) {
	...
	case 261: /* PROGRAM */
		/* file: PROGRAM */
		yytrace(a, 1, 0 + 0, p->cost[yyfile_NT]);
		if (0 + 0 < p->cost[yyfile_NT]) {
			p->cost[yyfile_NT] = 0 + 0;
			p->rule.yyfile = 1;
		}
		break;
	case 262: /* MODULE */
...
static void yyreduce(NODEPTR_TYPE p, int goalnt)
{
  ...
  switch(eruleno) {
	case 1: /* file: PROGRAM */
		fprintf(stderr, "0x%lx: line 37: file: PROGRAM\n",(long)p);
#line 37 "minor.brg"
